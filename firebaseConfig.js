...
import { getDatabase, ref, push, set, onValue, remove, update, get } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-database.js";
...
export { app, db, push, onValue, remove, set, ref, update, getDatabase, get };
